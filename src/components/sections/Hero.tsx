...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 section-padding section-divider">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary-start/5 rounded-full blur-[160px] animate-blob animation-delay-4000 pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <span className="text-sm font-medium text-accent-lavender transition-colors duration-300">Available for new opportunities</span>
        </motion.div>
      ...
      >
        <motion.div
          ...
          className="text-text-secondary opacity-50 transition-colors duration-300"
        >
          <ChevronDown size={32} />
        </motion.div>
      </motion.div>
